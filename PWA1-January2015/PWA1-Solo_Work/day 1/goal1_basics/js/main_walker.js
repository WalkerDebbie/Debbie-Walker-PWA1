...
// self-executing function - do this later!
(function (){
// Alert Hello World
alert("Hello user. Welcome back!");
console.log("Goal 1 Basic is working!");
document.write("Goal 1 Basic is working!");
...
console.log('------ variables ----------');
    ...
    var name="Debbie", course="PWA-1", month=1;
...
// string (definition, concatenation, escape character)
    ...
    //basic string
    var name4 = "Beyounce Knowles";
    var course4 = "Drunk In Love";
    var month4 = 1;
    ...
    var musicArtist = "She's in PWA-1";
    console.log(musicArtist);
    document.write("<br>" + musicArtist);

    //string w/ escape characters and mixed single/double quotes
    var testString = "Debbie needs some \"quotes\" to be here.";
    console.log(testString);
    document.write("<br>" + testString);


    //this example shows that all the "phase" vars above were overwritten
    var testString3 = 'She\'s in PWA-1';
    console.log("JayZ's song is 99 problems." + testString3);
    document.write("<br>" + "JayZ's song is 99 problems." + testString3);
...
console.log('------ numbers ----------');
    ...
    //basic math
    var num = 10;
    console.log("<br>" + "Debbie's Basic Math Counter works: " + num); //
    document.write("Debbie's Basic Math Counter works: " + num); //

    var counter = 10;
    console.log("Debbie's Basic Math Counter works: " + counter, 1); //
    document.write("<br>" + "Debbie's Basic Math Counter works: " + counter, 1); //add comma to add use + to concantenate
    ...
    var myNum = 5;
    console.log("Just myNum = ", myNum);// you can use a comma or + to concantenate a sentance
    ...
    myNum--;
    console.log("But myNum-- decreases by " + myNum);
    ...
    document.write("<br>" + "--PRE Decrement Counter: " + num);//8

    //this decrements after it is used
    num--;//started out as 9,
    ...
    console.log("Near Line 158, Counter-- results in: " + num--);//8
    document.write("<br>" + "Near Line 158, Counter-- results in: " + num--);//7
    ...
    document.write("Order of operations: " + num4);
 ...
 */
   var myArr = ['bond', 007, function(){}, true];
    ...
    document.write("<br>" + "index 0", myArr[1]);

    console.log("index 0", myArr[2]);
    document.write("<br>" + "index 0", myArr[2]);

    console.log("index 0", myArr[3]);
    document.write("<br>" + "index 0", myArr[3]);
 ...
 ********************************************/
    ...
    var arr1 = [10, 50, 100, 200];
    console.log("Sum = ", arr1[0] + arr1[1] + arr1[2] + arr1[3]);
    document.write("<br>" + "Sum = ", arr1[0] + arr1[1] + arr1[2] + arr1[3]);
 ...
 ********************************************/
    ...
    var myArray = new Array(); //this is a call so it does not get [ ]
    myArray[0] = "baseball";
    myArray[1] = "football";
...
*/
    ...
    */
    ...
    if(5 > 3){
        console.log(" '5 > 3:' , Ture!"); // = "true"
        document.write("<br>" + " '5 > 3:' , Ture!"); // = "true"
    };
...
*/
    ...
    //nested conditional statement
        ...
        if ("a" === "a"){  //1st IF statement
            ...
            if("b" === "b"){ //nexted IF statement : 2nd IF statement
            ...
            //execute this block of code if the 1st "IF" statement turns false
 ...
 *****************************
    ANONYMOUS FUNCTION  ////////////// USED MOSTLY FOR OBJECTS and this class!!!!
...
//function literal - example
    ...
    var myctr = 1; // intitialize oir variable to 1 - GLOBAL var
 ...
 ********************************************/
    ...
    myctr = 1; //initialize our variable to 1 - GLOBAL
...
myctr = 1; //initialize our variable to 1 - GLOBAL
    ...
    var cnt =  myCounter(5);
    console.log("counsole = ", cnt);
    document.write("<br>" + "counsole = ", cnt); // prints "console = 6"

    var cnt = myCounter(2);
    console.log("counsole = ", cnt);
    document.write("<br>" + "counsole = ", cnt);// prints "console = 8"
