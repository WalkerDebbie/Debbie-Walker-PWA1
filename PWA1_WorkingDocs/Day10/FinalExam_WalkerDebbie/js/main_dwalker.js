...
var button = document.querySelector(".buttonred"); // SETUP GLOBAL BUTTON WITH DOM ELEMENT
    //the document.querySelector manipulates the DOM element "buttonred"


// CREATE STUDENT ARRAY OF 2 OBJECTS
    var students = [ //students is one big array with 2 objects contained
        {
             name: "Mickey Mouse", //property name "name" and value "Mickey Mouse"
             address: {street:"2015 Disney Lane", city: "Orlando", state: "FL"}, //create an object that includes street, city and state
             gpa: [4.0, 3.75, 2.5],
             date: new Date()},
        {
            name: "Pluto",
...
addData('Debbie Walker', '123 My Super Hero Way', 'Orlando', 'Florida', [3.2, 4.0, 2.2], new Date()); //********** un-comment ONCE I HAVE ADDED THE DATA
console.log(' ');
